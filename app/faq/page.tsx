...
export default function FAQ() {
    const faqs = [
        ...
        {
            question: "후원금 영수증을 받을 수 있나요?",
            answer: `인증서가 공식 영수증 역할을 합니다:\n\n✓ 발급 기관: 대한학생회\n✓ 후원자 성명 및 후원 내용 명시\n✓ 인증번호를 통한 진위 확인 가능\n✓ PDF 다운로드 지원\n\n세금 공제가 필요하신 경우, 별도로 문의해주세요.`
        },
        {
            question: "후원 후 감사 편지나 영상을 받을 수 있나요?",
            answer: `네! 포털 페이지에서 확인하실 수 있습니다:\n\n✓ "편지 읽기" - 운영진의 감사 메시지\n✓ "영상 보기" - 활동 영상 및 사진 갤러리\n\n새로운 콘텐츠가 정기적으로 업데이트됩니다.`
        },
        {
